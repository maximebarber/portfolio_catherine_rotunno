...
const DEFAULT_IMAGES = [
    { id: '13', source: gorilleFull, thumbnail: gorilleThumb, caption: 'Le gorille', description: 'Huile sur toile - 60 x 80 - 677 €' },
    { id: '12', source: tigreFull, thumbnail: tigreThumb, caption: 'La tigresse', description: 'Huile sur toile - 90 x 120 - 557 €' },
    { id: '5', source: pontonFull, thumbnail: pontonThumb, caption: 'Ponton Lac Lésina', description: 'Huile sur palette - 137 x 100 - 457 €'},
    { id: '11', source: full11, thumbnail: thumb11, caption: 'La panthère', description: 'Huile sur palette - 137 x 100 - 457 €' },
    { id: '1', source: full01, thumbnail: thumb01, caption: 'Barque à Lesina 1', description: 'Huile sur palette - 137 x 100 - 457 €'},
    { id: '2', source: full02, thumbnail: thumb02, caption: 'Barque à Lesina 2', description: 'Huile sur palette - 137 x 100 - Déjà vendu'},
    { id: '3', source: full03, thumbnail: thumb03, caption: 'Barque à Lesina 3', description: 'Huile sur palette - 137 x 100 - 457 €'},
    { id: '4', source: full04, thumbnail: thumb04, caption: 'Bateau à Burano', description: 'Huile sur palette - 137 x 100 - 457 €'},
    { id: '6', source: full06, thumbnail: thumb06, caption: 'Les Genêts', description: 'Huile sur toile - 89 x 131 - 350 €'},
    ...
    { id: '10', source: full10, thumbnail: thumb10, caption: 'Plage à Lesina', description: 'Huile sur toile - 170 €'},
];
